...
public class EventController {
    ...
    private void createNotificationForEvent(Event event) {
        ...
        notification.setTitle("S? ki?n m?i: " + event.getTitle());
        notification.setContent("Thông báo v? s? ki?n: " + event.getTitle() + 
            "\nTh?i gian: " + (event.getDate() != null ? event.getDate() : "Chua xác d?nh") +
            "\nÐ?a di?m: " + (event.getLocation() != null ? event.getLocation() : "Chua xác d?nh") +
            "\nMô t?: " + (event.getDescription() != null ? event.getDescription() : "Không có mô t?"));
