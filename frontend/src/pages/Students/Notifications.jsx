...
const StudentNotifications = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      // Fetch general notifications for students
      const generalNotifications = await getNotificationsByRole("STUDENT");
      notificationsData = [...generalNotifications];

      // Fetch class-specific notifications if student has a class
      if (classId) {
        const classNotifications = await getNotificationsByClassAndRole(classId, "STUDENT");
