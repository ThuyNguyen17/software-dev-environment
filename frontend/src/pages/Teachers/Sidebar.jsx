...
import { BsGraphUp, BsPeople, BsFileText, BsBook, BsCalendar, BsGear, BsChatDots, BsCalendarEvent, BsSearch, BsMoon, BsSun, BsBell } from 'react-icons/bs';
...
const Sidebar = ({ isOpen, onToggle }) => {
  ...
  const navItems = [
    ...
    { path: '/teacher/notifications', label: 'Thông báo', icon: <BsBell /> },
