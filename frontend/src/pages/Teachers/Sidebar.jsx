...
const Sidebar = ({ isOpen, onToggle }) => {
  ...
  const navItems = [
    ...
    { path: '/teacher/classes', label: 'Classes', icon: <BsPeople /> },
    { path: '/teacher/students', label: 'Students', icon: <BsPeople /> },
    { path: '/teacher/teachers', label: 'Teachers', icon: <BsPerson /> },
    { path: '/teacher/assignments', label: 'Assignments', icon: <BsFileText /> },
    { path: '/teacher/exams', label: 'Exams', icon: <BsBook /> },
    { path: '/teacher/performance', label: 'Performance', icon: <BsGraphDown /> },
    { path: '/teacher/attendance', label: 'Attendance', icon: <BsCalendar /> },
    { path: '/teacher/communication', label: 'Announcement', icon: <BsChatDots /> },
    { path: '/teacher/events', label: 'Events & Calendar', icon: <BsCalendarEvent /> },
    { path: '/teacher/settings', label: 'Settings & Profile', icon: <BsGear /> },
  ];
